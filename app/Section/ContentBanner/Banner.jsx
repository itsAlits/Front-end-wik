...
export default function Banner() {
  return (
    <div className="wraper-image gap-4 grid grid-cols-12">
      <div className="col-span-9 flex items-center bg-white rounded-xl h-[400px] w-full imgMotor">
        <div className="text-justify ps-10">
          <div className="flex gap-2">
            <div className="badge badge-neutral py-[14px] ps-5 pe-3 mb-4 text-white">
              New Relase 🔥
            </div>
            <div className="badge badge-neutral py-[14px] px-3 mb-4 text-white">
              2024
            </div>
          </div>
          <h1 className="text-5xl font-semibold text-gray-700">Vespa LX 125</h1>

          <p className="font-reguler mt-4 text-[14px] text-gray-700 w-[50%]">
      ...
      <div className="col-span-3 flex justify-center items-end rounded-xl bg-white imgMotorOnly h-[400px]">
